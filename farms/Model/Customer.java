...
public class Customer {
 ...
 @Size(min = 1, max = 50, message = "Customer Password must be 50 characters maximum")
 ...
 @Min(value = 6, message = "Customer Agricultural Register Number must be exactly 6 digits")
 @Max(value = 6, message = "Customer Agricultural Register Number must be exactly 6 digits")
